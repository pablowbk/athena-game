  ...
  es: {
    ...
    itemDescriptions: {
      scroll: {
        ...
        examine:
          'El pergamino está hecho de pergamino desgastado, cubierto de texto griego antiguo con ilustraciones detalladas.',
    ...
    scenes: {
      ...
      next_chamber: {
        ...
        thief:
          'Tu experiencia en escapes se activa inmediatamente - notas los patrones desgastados en el suelo de piedra, marcando donde innumerables prisioneros han caminado antes. Las ventanas son demasiado estrechas para escapar, y las puertas están reforzadas con bronce celestial.',
      },
      athena_appears: {
      ...
      dedalo_quest: {
        ...
        wizard:
          'Percibes complejos encantamientos tejidos en las paredes del Laberinto - magia que cambia y altera los caminos. Quizás podrían ser manipulados.',
